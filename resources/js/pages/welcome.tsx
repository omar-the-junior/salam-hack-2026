    ...
    return (
        <>
            ...
            <div className="flex min-h-screen flex-col items-center bg-[#FDFDFC] p-6 text-[#1b1b18] lg:justify-center lg:p-8 dark:bg-[#0a0a0a]">
                <header className="mb-6 flex w-full max-w-[335px] text-sm not-has-[nav]:hidden lg:max-w-4xl">
                ...
                <div className="flex w-full items-center justify-center opacity-100 transition-opacity duration-750 lg:grow starting:opacity-0">
                    <main className="flex w-full max-w-[335px] flex-col-reverse lg:max-w-4xl lg:flex-row">
                        <div className="flex-1 rounded-ee-lg rounded-es-lg bg-white p-6 pb-12 text-[13px] leading-[20px] shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-ss-lg lg:rounded-ee-none lg:p-20 dark:bg-[#161615] dark:text-[#EDEDEC] dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]">
                            <h1 className="mb-1 font-medium">لنبدأ</h1>
                            <p className="mb-2 text-[#706f6c] dark:text-[#A1A09A]">
                                لارافيل يوفّر بيئة غنية للتطوير.
                                <br />
                                ننصحك بالبدء بما يلي.
                            </p>
                        ...
                        <div className="relative -mb-px aspect-[335/364] w-full shrink-0 overflow-hidden rounded-t-lg bg-[#fff2f2] lg:mb-0 lg:-ms-px lg:aspect-auto lg:w-[438px] lg:rounded-t-none lg:rounded-e-lg dark:bg-[#1D0002]">
                            {/* Laravel Logo */}
                            <svg
                            ...
                            {/* 13 */}
                            <svg
                                className="relative -mt-[6.6rem] -ms-8 w-[438px] max-w-none [--stroke-color:#1B1B18] lg:ms-0 dark:[--stroke-color:#FF750F]"
                                viewBox="0 0 440 392"
                                fill="none"
                                xmlns="http://www.w3.org/2000/svg"
                            >
                            ...
                            <div className="absolute inset-0 rounded-t-lg shadow-[inset_0px_0px_0px_1px_rgba(26,26,0,0.16)] lg:rounded-t-none lg:rounded-e-lg dark:shadow-[inset_0px_0px_0px_1px_#fffaed2d]"></div>
                        </div>
                    </main>
                </div>
