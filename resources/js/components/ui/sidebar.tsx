    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetHeader className="sr-only">
          ...
          <SheetDescription>عرض الشريط الجانبي على الجوال.</SheetDescription>
        </SheetHeader>
        <SheetContent
...
function SidebarTrigger({
  ...
  // PanelLeft* icons assume LTR; swap open/close glyphs in RTL so they match the sidebar edge.
  const showOpenIcon = isRtl ? !collapsed : collapsed
  ...
  return (
    <Button
      ...
      {...props}
    >
      {showOpenIcon ? <PanelLeftOpenIcon /> : <PanelLeftCloseIcon />}
      <span className="sr-only">طي/فتح الشريط الجانبي</span>
    </Button>
  )
}
...
function SidebarRail({ className, ...props }: React.ComponentProps<"button">) {
  ...
  return (
    <button
      ...
      aria-label="طي أو فتح الشريط الجانبي"
      tabIndex={-1}
      onClick={toggleSidebar}
      title="طي أو فتح الشريط الجانبي"
      className={cn(
